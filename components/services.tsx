...
export default function Services() {
  ...
  return (
    <section className="py-20 bg-brandGold/10" id="services">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="font-serif text-3xl md:text-4xl text-brandNavy mb-4">Our Services</h2>
            ...
            >
              <Card className="border-none shadow-lg hover:shadow-xl transition-shadow duration-300 h-full bg-white">
                <CardHeader className="pb-2">
                  ...
                  <CardTitle className="text-xl font-serif text-brandNavy">{service.title}</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-brandNavy/70">{service.description}</CardDescription>
                </CardContent>
              </Card>
            </motion.div>
          ))}
